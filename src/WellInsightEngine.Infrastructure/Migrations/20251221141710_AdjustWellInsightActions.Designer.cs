...
namespace WellInsightEngine.Infrastructure.Migrations
{
    ...
    [Migration("20251221141710_AdjustWellInsightActions")]
    partial class AdjustWellInsightActions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WellInsightEngine.Core.Entities.WellInsightAction", b =>
                {
                    ...
                    b.Property<Guid?>("InsightId1")
                        .HasColumnType("uuid")
                        .HasColumnName("insight_id1");

                    b.HasKey("InsightId", "WellActionId")
                        .HasName("pk_well_insight_actions");

                    b.HasIndex("InsightId1")
                        .HasDatabaseName("ix_well_insight_actions_insight_id1");
            ...
            modelBuilder.Entity("WellInsightEngine.Core.Entities.WellInsightAction", b =>
                {
                    ...
                    b.HasOne("WellInsightEngine.Core.Entities.WellInsight.WellInsight", "Insight")
                        .WithMany()
                        .HasForeignKey("InsightId1")
                        .HasConstraintName("fk_well_insight_actions_well_insights_insight_id1");

                    b.HasOne("WellInsightEngine.Core.Entities.WellAction", "WellAction")
                        .WithMany()
